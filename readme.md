...
Firefox/Chrome에서 치지직의 그리드 프로그램 요구를 우회합니다.<br/>
[설치하러가기(Firefox)](https://addons.mozilla.org/ko/firefox/addon/fuck-chzzk-grid/) / [설치하러가기(Chrome/zip파일 수동설치)](https://github.com/refracta/FUCK-CHZZK-GRID-CHROME?tab=readme-ov-file#%EC%84%A4%EC%B9%98-%EB%B0%A9%EB%B2%95)
...
## Chrome Version
크롬의 경우  아래 레포에서 이용하실 수 있습니다(수동 설치)<br>
크롬버전을 포팅해주신 [@refracta](https://github.com/refracta)님께 다시한번 감사의 말씀 드립니다.

https://github.com/refracta/FUCK-CHZZK-GRID-CHROME
...
F12 -> 네트워크 탭에서 `chunklist_1080p.m3u8` 혹은 `/1080p/~~~chunklist.m3u8`로 이루어진 요청이 계속 표시되는지 확인해보세요.<br/>
만약 `chunklist_1080p.m3u8` 혹은 `/1080p/~~~chunklist.m3u8`로 표시되지 않는다면 스크린샷과 함께 이슈를 남겨주세요. 최대한 빠르게 해결해드리겠습니다.
...
-   루션: 치지직 올인원 스크립트 화질고정 스크립트 수정본 제공
-   [@refracta](https://github.com/refracta): FUCK-CHZZK-GRID Chrome 버전 포팅
